...
$root = rtrim($_SERVER['DOCUMENT_ROOT'].'alice','/'); // don't touch this configuration
...
//$base_url = 'http://nuevo.elpueblopresidente.com';
$base_url="http://localhost:81/alice"; //url base of site if you want only relative url leave empty
$upload_dir = '/webroot/files/tinymce/source/'; // path from base_url to upload base dir
$current_path = '../../../../files/tinymce/source/'; // relative path from filemanager folder to upload files folder
